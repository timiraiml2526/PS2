...
RECS = [
    ("s","🤸 Stretch","Chin Tucks",
     "Gently pull chin straight back, creating a double chin. Hold 5 sec, repeat 10×/hr. Counters forward-head posture.","bad"),
    ("s","🤸 Stretch","Doorway Chest Stretch",
     "Stand in doorway, forearms on frame at 90°, lean forward gently. Hold 20-30 sec. Releases hunching tightness.","bad"),
    ...
    ("e","💪 Exercise","Wall Angels",
     "Back flat on wall, arms at 90°, slide up and down like a snow angel. 3×10. Activates deep postural muscles.","bad"),
    ("e","💪 Exercise","Band Pull-Aparts",
     "Hold resistance band at shoulder width, pull it apart horizontally. 3×15. Strengthens rhomboids and rear delts.","bad"),
    ("e","💪 Exercise","Dead Bug",
     "Lie on back, extend opposite arm and leg slowly, lower back pressed down. 3×8/side. Core stability for upright posture.","warn"),
    ("e","💪 Exercise","Prone Cobra",
     "Face down, squeeze shoulder blades, lift chest slightly. Hold 10 sec, repeat 10×. Strengthens spinal extensors.","warn"),
    ("e","💪 Exercise","Plank",
    ...
    ("g","🪑 Ergonomics","Chair Height & Lumbar",
     "Feet flat on floor, knees at ~90°. Use a lumbar pillow behind lower back to maintain natural spinal curve.","bad"),
...
if bad_pct>=40:   st.error(f"⚠️ Bad posture was **{bad_pct}%** of the session. High-priority fixes below.")
